...
import article2 from "../../public/images/articles/create_loading_screen_in_reactjs.jpg";
import article3 from "../../public/images/articles/form_validation_in_reactjs_using_custom_react_hook.png";
  ...
  return (
    <li className="relative col-span-1 w-full p-4 bg-light border  border-solid border-dark rounded-2xl dark:bg-dark dark:border-light">
      ...
      <Link href={link} target="_blank">
        <h2 className="capitalize text-2xl my-2 font-bold  hover:underline hover:underline-offset-1">
          {title}
        </h2>
      </Link>
...
export default function articles() {
  return (
    <>
      <Head>
        <title>EdsonGomes | Articles Page</title>
